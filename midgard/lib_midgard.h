/* $Id: lib_midgard.h 6908 2002-11-04 10:48:23Z daniel $
 *
...
// Symbol LIB_MIDGARD_EXPORTS kompiliert. Dieses Symbol sollte für kein Projekt definiert werden, das
// diese DLL verwendet. Auf diese Weise betrachtet jedes andere Projekt, dessen Quellcodedateien diese Datei 
// einbeziehen, LIB_MIDGARD_API-Funktionen als aus einer DLL importiert, während diese DLL mit diesem 
// Makro definierte Symbole als exportiert betrachtet.
#ifdef LIB_MIDGARD_EXPORTS
#define LIB_MIDGARD_API __declspec(dllexport)
#else
#define LIB_MIDGARD_API __declspec(dllimport)
#endif
