...
extern GType midgard_group_constraint_get_type(void);

extern MidgardGroupConstraint *midgard_group_constraint_new(const gchar *type);

extern void midgard_group_constraint_add_constraint(
