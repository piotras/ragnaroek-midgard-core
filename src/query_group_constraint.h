...
extern GType midgard_query_group_constraint_get_type(void);

extern MidgardQueryGroupConstraint *midgard_query_group_constraint_new(void);

extern void midgard_query_group_constraint_add_sql(
        MidgardQueryGroupConstraint *self, GString *sql);

extern gboolean midgard_query_group_constraint_type_is_valid(const gchar *type);

/* PRIVATE */
extern MidgardQueryGroupConstraintPrivate *midgard_query_group_constraint_private_new(void);
extern void midgard_query_group_constraint_private_free(MidgardQueryGroupConstraintPrivate *mqcp);
